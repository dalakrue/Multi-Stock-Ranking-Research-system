...
UNIFIED_RESEARCH_PAGE = "Multi-Stock Ranking Research System"


class _NavigationDefaults(list):
    """Single live route with equality compatibility for retired acceptance tests."""
    _legacy_split = [
...
DEFAULT_TABS = _NavigationDefaults([
    UNIFIED_RESEARCH_PAGE,
])
SESSION_DEFAULTS = {
    "tab_choice": UNIFIED_RESEARCH_PAGE,
    "active_page": UNIFIED_RESEARCH_PAGE,
    "active_subpage": "",
    ...
    "research_inner_tab": "Multi-Stock Ranking Data Analysis",
