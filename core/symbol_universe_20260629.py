...
def apply_symbol_selection(
    ...
    *,
    ...
    state["multi_symbol_main_symbol_20260702"] = selected
    state["connector_symbol_20260702"] = selected
    ...
    if isinstance(selected_symbols, (list, tuple, set)):
        ...
        state["multi_symbol_selected_20260701"] = [selected, *[item for item in normalized_selected if item != selected]]
    else:
        state["multi_symbol_selected_20260701"] = [selected]
