...
# Three equal selectors create one canonical 30-symbol research universe.
...
DEFAULT_GROUPS = {
    "FIRST": ["XAUUSD", "AUDUSD", "EURUSD", "EURCAD", "EURCHF", "EURGBP", "USDCHF", "NZDUSD", "GBPCHF", "GBPAUD"],
    "SECOND": ["USDJPY", "GBPUSD", "USDCAD", "EURJPY", "GBPJPY", "EURAUD", "EURNZD", "GBPCAD", "AUDJPY", "XAGUSD"],
    "THIRD": ["DXY", "AUDCAD", "AUDCHF", "AUDNZD", "CADCHF", "CADJPY", "CHFJPY", "GBPNZD", "NZDCAD", "NZDJPY"],
}
SCOPE_TO_GROUP = {
    "LUNCH_CORE": "FIRST",
    "QUICK": "SECOND",
...
def mark_run_group(state: MutableMapping[str, Any], scope: Any, symbols: Any) -> tuple[str, list[str]]:
    ...
    # selectors; each selector has a 10-symbol capacity.
    ...
    if selected:
        ...
        state["connector_symbol_20260702"] = selected[0]
