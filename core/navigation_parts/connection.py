...
def _saved_connector_profile() -> dict:
    ...
    st.session_state["multi_symbol_main_symbol_20260702"] = main
    st.session_state["connector_symbol_20260702"] = main
    st.session_state["symbol"] = main
    st.session_state["selected_symbol"] = main
...
def _connect_now(label="Refresh", quick=False, force=False):
    ...
    st.session_state["multi_symbol_main_symbol_20260702"] = main_symbol
    st.session_state["symbol"] = main_symbol
    st.session_state["selected_symbol"] = main_symbol
