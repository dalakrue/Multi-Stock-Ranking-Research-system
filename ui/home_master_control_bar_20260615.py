...
def render_home_master_control_bar(current_tab: str | None = None) -> None:
    ...
    active = str(current_tab or st.session_state.get("active_page") or "Multi-Stock Ranking Research System")
    active = {
        "Home": "Multi-Stock Ranking Research System",
        "Data Visualization": "Multi-Stock Ranking Research System",
    }.get(active, active)
    if active not in pages:
        from core.navigation_state_20260627 import normalize_page
        active = normalize_page(active, "Multi-Stock Ranking Research System")
