...
def _sync_status() -> None:
    try:
        ...
        page = st.session_state.get("active_page", "Multi-Stock Ranking Research System")
...
def _open_lunch_after_calculation() -> None:
    st.session_state.update({
        "active_page": "Multi-Stock Ranking Research System",
        "tab_choice": "Multi-Stock Ranking Research System",
...
def render_main_menu_drawer(current_tab: str | None = None) -> str:
    ...
    try:
        ...
        pass
    pages = {"Multi-Stock Ranking Research System"}
    if current_tab and current_tab in pages:
        st.session_state.setdefault("active_page", current_tab)
    st.session_state.setdefault(
        "active_page",
        st.session_state.get("tab_choice", "Multi-Stock Ranking Research System"),
    )
    ...
    if active == "Menu":
        ...
        try:
            ...
            page_list = ["Multi-Stock Ranking Research System"]
            current = st.session_state.get("active_page", "Multi-Stock Ranking Research System")
